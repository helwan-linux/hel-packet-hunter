...
class GameScreen(QWidget):
    ...
    def _custom_paint_event(self, event):
        ...
        painter.drawRect(QRect(int(sniffer_rect[0]), int(sniffer_rect[1]), int(sniffer_rect[2]), int(sniffer_rect[3])))
        ...
        for packet in self.game_logic.packets:
            ...
            painter.drawText(QRect(int(packet_rect[0]), int(packet_rect[1]) - 20, int(packet_rect[2]), 20),
